    ...
    <div class="card" style="width: 100%;">
        ...
        <div class="card-body">
            <form action="{{ route('res_assistance_process') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('assistance_type_id') is-invalid @enderror"
                                    name="assistance_type_id" id="assistance_type_id"
                                ...
                                <img id="blah" class="img img-thumbnail"
                                    src="{{ asset('storage/default_image.jpg') }}" alt="your image" />
                ...
                @else
                    <p>You have a pending request, you cannot proceed.</p>
                @endif
            </form>
        </div>
    </div>
