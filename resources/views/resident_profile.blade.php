    ...
    <div class="row">
            ...
            <div class="card" style="width: 100%;">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <form action="{{ route('resident_profile_update') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
        ...
        <div class="col-md-4">
            <div class="card" style="width: 100%;">
                ...
                <form action="{{ route('resident_profile_image_update') }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-12">
                            <img src="{{ asset('/storage/' . $resident->user_image) }}" alt=""
